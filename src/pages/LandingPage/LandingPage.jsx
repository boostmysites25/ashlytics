...
export default function LandingPage({ page }) {
  ...
  return (
        ...
        <div className="wrapper flex flex-col-reverse lg:grid grid-cols-[65%_1fr] items-center lg:items-end gap-5">
          ...
          >
            ...
            <p className="desc max-w-2xl pb-3">
              {isWeb
                ? "Your website is the digital face of your business. It deserves to be innovative, user-friendly, and aligned with the latest trends. At Ashlytics, we create custom-built web solutions designed to deliver exceptional user experiences, seamless functionality, and business growth."
                : "Your business deserves a mobile app that not only meets today’s needs but is ready for the challenges of tomorrow. At Ashlytics, we craft custom-built mobile applications that deliver seamless user experiences, drive engagement, and accelerate growth across iOS, Android, and cross-platform environments."}
            </p>
          ...
          <div data-aos="fade-right" className="space-y-5 py-4 w-full">
            <h3 className="text2">
              ...
              <span className="text-primary1">
                Ashlytics {isWeb ? "Web" : "App"} Solutions
              </span>
            </h3>
            <h3 className="text2">
              Where Your{" "}
            ...
            <p
              ...
              dangerouslySetInnerHTML={{
                __html: isWeb
                  ? `At Ashlytics, we specialize in building high-performance,
              ...
              landscape.`
                  : `At Ashlytics, we specialize in building high-performance, scalable, and 
    ...
    we develop apps that are innovative, efficient, and built for long-term success.`,
            ...
            ></p>
            <h5 className="text4">
              <span className="text-[#f4ad13]">Ashlytics:</span>{" "}
              {isWeb
