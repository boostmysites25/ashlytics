    ...
    <div className="bg-white text-black py-14">
      ...
      >
        <div className="relative space-y-4">
          <div className="w-[8rem] h-[8rem] rounded-full bg-[radial-gradient(circle,_#FFFFFF,_#f4ad13)] absolute bottom-[1rem] right-4 sm:right-[4rem] drop-shadow-2xl z-[1]"></div>
          <div
            data-aos="fade-right"
          ...
          <p>
            At Ashlytics, every service starts with your specifications. We
            don’t believe in one-size-fits-all. We craft smart, scalable, and
        ...
        >
          {ourServices.concat(ourServices, ourServices).map((item) => (
