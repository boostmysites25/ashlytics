  ...
  return (
    <div className="py-14 relative overflow-hidden">
      ...
      <div data-aos="fade-up" className="wrapper text-center space-y-3 mb-8">
        <h2 className="text1 text-primary2">Client Success Stories</h2>
        <p className="desc max-w-4xl mx-auto">
          Discover how businesses across industries have achieved remarkable
          results through our innovative web and mobile solutions. These success
          stories demonstrate our commitment to delivering exceptional digital
          experiences that drive real business growth and exceed client
          expectations.
        </p>
      </div>
      <Swiper
