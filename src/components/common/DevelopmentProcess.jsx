  ...
  return (
    <section className="relative py-14 text-black bg-white h-[calc(100%+3rem)] overflow-hidden">
      <div
        ...
        className="z-0 w-[8rem] h-[8rem] rounded-full bg-[radial-gradient(circle,_#FFFFFF,_#f4ad13)] absolute top-[10rem] left-[5rem] drop-shadow-2xl"
      ></div>
      <div
        data-aos="fade-up-right"
        className="z-0 w-[10rem] h-[10rem] rounded-full bg-[radial-gradient(circle,_#FFFFFF,_#f4ad13)] absolute -bottom-4 -right-4 drop-shadow-2xl"
      ></div>
      <div className="wrapper text-center space-y-3 z-[1] relative">
        ...
        <p data-aos="fade-up" className="desc max-w-4xl mx-auto">
          At Ashlytics, our development approach ensures precision, efficiency,
