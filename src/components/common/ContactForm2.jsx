  ...
  return (
    ...
    >
      {isDark ? (
        ...
        <div
          data-aos="fade-up-right"
          className="z-0 w-[8rem] md:w-[12rem] h-[8rem] md:h-[12rem] rounded-full bg-[radial-gradient(circle,_#FFFFFF,_#f4ad13)] absolute -bottom-4 -right-4 drop-shadow-2xl"
        ></div>
      )}
      <div className="wrapper flex flex-col-reverse md:grid grid-cols-2 gap-7 relative z-[1]">
        ...
        >
          ...
          <div className="space-y-1 grid">
            ...
            <input
              ...
              {...register("subject", {
                ...
                validate: (value) => {
                  if (value.trim() === "") {
                    return "Service interest is required";
                  }
                },
              })}
            />
          ...
          <div className="space-y-1 grid">
            <label className="text-sm">Project Requirements</label>
            <textarea
              className="p-3 rounded-[2rem] outline-none border-2 border-primary bg-transparent w-full"
              ...
              {...register("message", {
                ...
                validate: (value) => {
                  if (value.trim() === "") {
                    return "Project requirements are required";
                  }
                },
              })}
            />
        ...
        <div className="space-y-4">
          <h2 className="text1">Let's Connect</h2>
          <div className="h-2 w-[18rem] bg-black"></div>
          <h5 className="text2">
            Ready to Transform Your Digital Presence?
          </h5>
          <p className="desc">
            Your digital success story starts with a conversation. Let's discuss
